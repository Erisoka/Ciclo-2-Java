...
public class reto01dev {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Registros que se debn ingresar: "+registrosInteger);
        ...
        // Promedio del grupo, conteo examenes insuficientes
